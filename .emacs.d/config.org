...
#+begin_src emacs-lisp
  ...
  (add-hook 'org-roam-find-file-hook 'recentf-save-list)
  (add-hook 'org-roam-dailies-goto-today 'recentf-save-list)
...
#+begin_src emacs-lisp
    ...
    :no-require
    :custom
    (org-cite-global-bibliography '("~/Sync/Citations/Citations.bib"))
...
#+end_src
**** Haskell
Install ~haskell-language-server-static~ from aur
#+begin_src emacs-lisp
