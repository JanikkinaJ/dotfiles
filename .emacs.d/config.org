...
#+begin_src emacs-lisp
  ...
  ;; make org mode look more modern
...
#+begin_src emacs-lisp
  ...
  (add-hook 'org-mode-hook 'org-bullets-mode) ;; bullets now have icons instead
...
#+begin_src emacs-lisp
  ...
  ;; predefined tags that i can autocomplet when running org-set-tags-command 
